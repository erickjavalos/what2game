...
const SearchGame = () => {
        ...
        <div className="w-full flex flex-col items-center justify-center mb-4">
          <div className="bg-yellow-400 rounded-lg px-4 py-2">
            <h5
              ...
              style={{ fontSize: "36px", color: "#FFD400" }}
            >
              {game.name}
            </h5>
            <p
              className="text-gray-700 text-base mb-0"
              style={{ fontSize: "24px", color: "#FFD400" }}
            >
              {game.released}
            </p>
          </div>
  ...
  return (
    <div
      className="container mx-auto bg-purple-900"
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex mb-4 justify-center">
          ...
          <button
            type="submit"
            className="px-6 rounded-r-lg bg-blue-600 text-white font-bold p-4 uppercase border-blue-500 border-t border-b border-r"
          >
            Search
          </button>
        </div>
